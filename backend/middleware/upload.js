...
// };
  /**
 * Enhanced upload.js
 * - Preserves existing exports (upload, uploadAny, uploadSingle, uploadFields, handleFileUploads)
 * - Adds SEPARATE uploaders:
 *     - uploadImage: JPG/PNG only, saved under /uploads/images
 *     - uploadImport: CSV/XLSX only, saved under /uploads/imports
 *   Use these in routes like:
 *     router.post('/categories/import', auth, uploadImport.single('file'), controller.importCategories)
 *     router.post('/products/image', auth, uploadImage.single('product_img'), controller.uploadImage)
 */

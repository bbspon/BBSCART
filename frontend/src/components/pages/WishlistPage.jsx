...
const pickWishlistImage = (product) => {
  let raw =
    product?.product_img_url ||
    product?.image ||
    product?.product_img ||
    (Array.isArray(product?.gallery_imgs) ? product.gallery_imgs[0] : "");
        ...
        {wishlistItems && wishlistItems.length > 0 ? (
          <div className="flex flex-wrap w-full mb-[-24px]">
            <div className="w-full px-[12px] mb-[24px]">
              <div
                className="bb-wishlist-table border-[1px] border-solid border-[#eee] rounded-[20px] overflow-hidden max-[1399px]:overflow-y-auto aos-init aos-animate"
                data-aos="fade-up"
                            ...
                            <div>
                              ...
                              <div className="px-2">
                                {Array.from({ length: 5 }).map((_, index) => (
                                  <i
                                    key={index}
                                    className={`ri-star-fill float-left text-[15px] mr-[3px] ${index < product?.rating
                                        ? "text-[#e7d52e]"
                                        : "text-[#777]"
                                      }`}
                                  ></i>
              ...
              <Link
                to="/"
                className="bb-btn-2 mt-[24px] inline-flex items-center justify-center check-btn transition-all duration-[0.3s] ease-in-out font-Poppins leading-[28px] tracking-[0.03rem] py-[8px] px-[20px] text-[14px] font-normal text-[#fff] bg-primary rounded-[10px] border-[1px] border-solid border-primary hover:bg-transparent hover:text-secondary aos-init aos-animate"
                data-aos="fade-up"
                data-aos-duration="1000"
                data-aos-delay="400"
              >
          ...
          <div className="w-full text-center">
            <h3 className="font-Poppins text-[20px] text-secondary">

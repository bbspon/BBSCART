            ...
            {loading ? (
              ...
              rows.map((f) => (
                <tr key={f._id} style={{ borderTop: "1px solid #eee" }}>
                  <td style={{ padding: 10 }}>
                    {(f.vendor_fname || "") + " " + (f.vendor_lname || "")}
                  </td>
                  <td style={{ padding: 10 }}>{f.pan_number || ""}</td>
                  <td style={{ padding: 10 }}>{f.aadhar_number || ""}</td>
                  <td style={{ padding: 10 }}>{f.gst_number || ""}</td>
                  <td style={{ padding: 10 }}>
                    {f.submitted_at
                  ...
                  <td style={{ padding: 10 }}>
                    <button onClick={() => setReviewId(f._id)}>Review</button>
                  </td>
                </tr>
              ))
            )}

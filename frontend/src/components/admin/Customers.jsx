...
const Customers = () => {
  ...
  <div className="container mx-auto p-4">
    ...
    >
      <div className="p-0 bg-transparent flex items-center justify-center min-h-[300px]">
        <div className="bg-white rounded-2xl shadow-2xl border border-gray-200 max-w-md w-full p-8 flex flex-col items-center">
          ...
          <h3 className="text-xl font-bold text-gray-800 mb-2 text-center">Delete Customer?</h3>
          <p className="text-gray-600 text-center mb-6">Are you sure you want to delete this customer? <br/>This action cannot be undone.</p>
    ...
    {/* Enhanced Add Customer & Search Bar UI */}
    ...
    <div className="mt-8">
      <h2 className="text-xl font-bold mb-4 text-gray-800 dark:text-gray-100 tracking-tight">Customer List</h2>
        ...
        <div className="w-full px-2 mb-4">
          <div className="overflow-x-auto rounded-xl shadow border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900">
            {paginatedUsers.length === 0 ? (
              <p className="text-gray-500 p-4 text-center text-sm">No customers available.</p>
            ) : (

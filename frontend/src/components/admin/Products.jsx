        ...
        <section id="content">
          ...
          <main>
            ...
            <div className="container mx-auto p-4">
              ...
              >
                <div className="p-0 bg-transparent flex items-center justify-center min-h-[300px]">
                  <div className="bg-white rounded-2xl shadow-2xl border border-gray-200 max-w-md w-full p-8 flex flex-col items-center">
                    ...
                    <h3 className="text-xl font-bold text-gray-800 mb-2 text-center">Delete Product?</h3>
                    <p className="text-gray-600 text-center mb-6">Are you sure you want to delete this product? <br/>This action cannot be undone.</p>
              ...
              {/* Enhanced Add Product & Search Bar UI */}

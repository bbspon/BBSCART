            ...
            <div className={isDarkMode ? 'dark' : ''}>
                ...
                <section id="content">
                    ...
                    <main>
                        ...
                        >
                            <div className="p-0 bg-transparent flex items-center justify-center min-h-[300px]">
                              <div className="bg-white rounded-2xl shadow-2xl border border-gray-200 max-w-md w-full p-8 flex flex-col items-center">
                                ...
                                <h3 className="text-xl font-bold text-gray-800 mb-2 text-center">Delete SubCategory?</h3>
                                <p className="text-gray-600 text-center mb-6">Are you sure you want to delete this subcategory? <br/>This action cannot be undone.</p>
                        ...
                        {/* Enhanced Add SubCategory & Search Bar UI */}
                        ...
                        <div className="mt-8">
                          <h2 className="text-xl font-bold mb-4 text-gray-800 dark:text-gray-100 tracking-tight">Sub Category List</h2>
                            ...
                            <div className="w-full px-2 mb-4">
                              <div className="overflow-x-auto rounded-xl shadow border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900">
                                {paginatedCategories.length === 0 ? (
                                  <p className="text-gray-500 p-4 text-center text-sm">No subcategories available.</p>
                                ) : (
                                  <table className="w-full table-auto border-collapse text-sm">
                                    <thead className="bg-gray-100 dark:bg-gray-800">
                                      <tr>
                                        <th className="font-Poppins p-2 pl-6 text-left font-semibold text-gray-700 dark:text-gray-200 tracking-wide">SubCategory Name</th>
                                        <th className="font-Poppins p-2 text-left font-semibold text-gray-700 dark:text-gray-200 tracking-wide">Category Name</th>
                                    ...
                                    <tbody>
                                      {paginatedCategories.map((subcategory) => (
                                        <tr key={subcategory._id} className="border-b border-gray-100 dark:border-gray-800 hover:bg-blue-50 dark:hover:bg-gray-800/60 transition">
